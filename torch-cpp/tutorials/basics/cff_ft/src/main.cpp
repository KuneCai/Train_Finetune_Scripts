...
int main() {
    ...
    const std::string CFF_model_path = "../../../../saved_model/traincff.ckpt";
    std::cout << CFF_model_path << std::endl;
    torch::load(model, CFF_model_path);
    model->to(device);
    ...
    const std::string CFF_FT_model_path = "../../../../saved_model/finetunecff.ckpt";
    
    torch::save(model, CFF_FT_model_path);
