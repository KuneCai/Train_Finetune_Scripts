...
net_fp32_fused = torch.quantization.fuse_modules(net_fp32, [['conv1', 'relu1'], ['fc1', 'relu2']])
...
net_fp32_prepared.load_state_dict(torch.load('./saved_model/qtraincff_fp32.ckpt'))
...
#
# torch.save(net_fp32_prepared.state_dict(), './saved_model/qtraincff_fp32.ckpt')
# torch.jit.save(torch.jit.script(net_int8), './saved_model/qtraincff_int8.ckpt')
